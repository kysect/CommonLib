...
namespace Kysect.CommonLib.Internal;

public static class PathNetCore
{
    internal static string GetRelativePath(IFileSystem fileSystem, string relativeTo, string path)
    {
        return GetRelativePath(fileSystem, relativeTo, path, StringComparison);
    }

    private static string GetRelativePath(IFileSystem fileSystem, string relativeTo, string path, StringComparison comparisonType)
    {
